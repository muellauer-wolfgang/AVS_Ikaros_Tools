...
namespace Splitbuchungen_Auflösen.Startup
{
  public class Bootstrapper
  {
    public IContainer Bootstrap()
    {
      ...
      builder.RegisterType<SQL_Anywhere_Service>().As<ISQL_Anywhere_Service>().SingleInstance();
      //builder.RegisterType<Verzinsungs_Service_Lokal>().As<IVerzinsungs_Service>().SingleInstance();
      builder.RegisterType<Verzinsungs_Service_Ikaros>().As<IVerzinsungs_Service>().SingleInstance();
